...
class MeasuresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measure" do
    assert_difference('Measure.count') do
      post measures_url, params: { measure: { description: @measure.description, title: @measure.title } }
    end
  ...
  test "should update measure" do
    patch measure_url(@measure), params: { measure: { description: @measure.description, title: @measure.title } }
